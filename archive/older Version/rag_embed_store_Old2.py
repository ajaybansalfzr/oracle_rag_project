    ...
    for _, row in df.iterrows():
        ...
        """,
            (
                vector_id,
                "primary",
                row_data.get("Document_Name", ""),
                row_data.get("Chapter", ""),
                row_data.get("Section", ""),
                row_data.get("SubSection", ""),
                row_data.get("Paragraph_Synopsis", ""),
                row_data.get("Sentence_Count", 0),
                row_data.get("Additional_Context", ""),
                row_data.get("Header", ""),
                row_data.get("Footer", ""),
                row_data.get("Indexed_Text", ""),
                row_data.get("Table_Delimited", ""),
                row_data.get("Hyperlinks", ""),
        ...
        secondary_text = "\n".join(
            filter(None, meta_parts)
        )  # filter(None, ...) to avoid empty strings creating extra newlines
