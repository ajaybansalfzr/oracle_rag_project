...
"""
    ...
    try:
        ...
        # print(f"    - Details: {e}")
        logger.error(f"Could not connect to Ollama at {OLLAMA_URL}. Is it running? Details: {e}")
        ...
        for doc in docs_to_process:
            ...
            for section in tqdm(sections_to_process, desc=f"  - Processing Sections for '{doc_name}'"):
                ...
                for chunk_text_content in chunks:
                    ...
                    all_chunks_for_doc.append((section_id, chunk_text_content, chunk_summary))
            ...
            if all_chunks_for_doc:
                ...
                logger.info(
                    f"Successfully inserted {len(all_chunks_for_doc)} chunks and their summaries for '{doc_name}'."
                )
