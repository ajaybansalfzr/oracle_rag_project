...
from scripts.utils.utils import (  # save_to_csv, is no longer needed
        ...
        try:
            ...
            if existing_doc:
                if existing_doc["file_hash"] == file_hash:
                    ...
                    logger.info(
                        f"Removed old doc_id {old_doc_id}, {chunks_deleted} associated chunks, and all sections. Proceeding with new version."
                    )
