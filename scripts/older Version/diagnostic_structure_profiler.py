...
def main():
                    ...
                    if b.get("type") == 0: # It's a text block
                        try:
                            ...
                            block_data = {
                                ...
                                "hyperlink_text": page_enrichments["hyperlink_text"] if is_first_block_on_page else "",
    ...
    if not main_diagnostic_rows:
        ...
        with open(csv_path_main, "w", newline="", encoding="utf-8") as f:
            headers = ["page_num", "section_id", "indexed_text", "header_footer_text", "image_text", "hyperlink_text", "table_text"]
